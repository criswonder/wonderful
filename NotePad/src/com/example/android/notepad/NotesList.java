...
public class NotesList extends ListActivity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		List<ResolveInfo> lst = pm.queryIntentActivityOptions(null, null,
	...
	public boolean onPrepareOptionsMenu(Menu menu) {
		...
		if (haveItems) {
			...
			// 下面的方法会调用contentprovider的getType方法，因为系统要resolve这个intent
			List<ResolveInfo> lst = pm.queryIntentActivityOptions(null, null,
					specifics[0], PackageManager.MATCH_DEFAULT_ONLY);
			...
			// ----------------------------------------------------------------------------------------------------
			// 对于疑问edit menu是怎么加进去的。就是因为下面的specifics. 你可以把specifics设为Null 看看效果。
			// ----------------------------------------------------------------------------------------------------
