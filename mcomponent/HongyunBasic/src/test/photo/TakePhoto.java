	    ...
	    case TAKE_PICTURE:
	        if (resultCode == Activity.RESULT_OK) {
	            ...
	            try{
                    ...
                    String latidude=exif.getAttribute(ExifInterface.TAG_GPS_LATITUDE);
                    String longitude=exif.getAttribute(ExifInterface.TAG_GPS_LONGITUDE);
                    Toast.makeText(TakePhoto.this,convertToDegree(latidude)+":"+convertToDegree(longitude), Toast.LENGTH_SHORT).show();
...
//                    Toast.makeText(TakePhoto.this,latidude+":"+longitude, Toast.LENGTH_LONG).show();
                    }
                    catch(Exception ee){
                        ee.printStackTrace();
                    } 
	 ...
	 * @param stringDMS  Format is "num1/denom1,num2/denom2,num3/denom3". like: 120/1,1/1,339331/10000
	 * @return 转换成float
	 */
