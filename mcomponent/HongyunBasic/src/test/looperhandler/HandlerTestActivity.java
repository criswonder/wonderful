...
/**
 * 使用 在主线程里面创建的handler来更新主界面
 * http://www.cnblogs.com/leon19870907/archive/2012/02/25/2367549.html
 * @author wonder
 *
 */
public class HandlerTestActivity extends Activity implements
	...
	private EHandler mHandler = new EHandler();
...
//			}
			...
			Message m = mHandler.obtainMessage(1, 1, 1, "Message from new thread!");
