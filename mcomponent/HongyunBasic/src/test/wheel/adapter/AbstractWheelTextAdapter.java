...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
    ...
    /** Default text color */
    public static final int DEFAULT_TEXT_COLOR = 0xFF707070;
    ...
    public static final int DEFAULT_VIEW_WIDTH = 36;
    ...
    protected AbstractWheelTextAdapter(Context context, int itemResource, int itemTextResource) {
        ...
        textSize = (int)(DEFAULT_TEXT_SIZE * density);
        viewWidth = (int)(DEFAULT_VIEW_WIDTH * density);
    }
