/*
Ø * Copyright (C) 2011 Patrik Åkerfeldt
 * 
...
//		setMinimumHeight(300);
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN:
			Log.i("trackTouchPoint", "ACTION_DOWN X="+x);
			/*
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (mTouchState == TOUCH_STATE_SCROLLING) {
				...
				Log.i("onInterceptTouchEvent", "deltaX="+deltaX+"scrollX="+scrollX);
...
//				}
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			Log.i("trackTouchPoint", "ACTION_MOVE X="+x);
			final int xDiff = (int) Math.abs(x - mLastMotionX);
		...
		case MotionEvent.ACTION_UP:
			Log.i("trackTouchPoint", "ACTION_UP X="+x);
			if (mTouchState == TOUCH_STATE_SCROLLING) {
				final VelocityTracker velocityTracker = mVelocityTracker;
				velocityTracker.computeCurrentVelocity(1000, mMaximumVelocity);
				int velocityX = (int) velocityTracker.getXVelocity();
			...
			break;
		case MotionEvent.ACTION_CANCEL:
			Log.i("trackTouchPoint", "ACTION_CANCEL X="+x);
			snapToDestination();
			mTouchState = TOUCH_STATE_REST;
		}
		return true;
	...
	protected void onScrollChanged(int h, int v, int oldh, int oldv) {
		...
		if (mIndicator != null) {
			...
			Log.i("onScrollChanged","h="+h+", hPerceived="+hPerceived+", getWidth="+getWidth()+", mCurrentAdapterIndex="+mCurrentAdapterIndex+",mCurrentBufferIndex="+mCurrentBufferIndex);
		}
	}
