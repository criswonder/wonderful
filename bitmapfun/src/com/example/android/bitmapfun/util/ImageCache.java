...
import com.example.android.bitmapfun.provider.MyApplication;
...
public class ImageCache {
    ...
    public static ImageCache findOrCreateCache(
            MyApplication fragmentManager, ImageCacheParams cacheParams) {
    ...
    public static File getDiskCacheDir(Context context, String uniqueName) {
    	...
    	boolean b2 = !isExternalStorageRemovable();
    	boolean b = b1|| b2;
    	File file = getExternalCacheDir(context);
        final String cachePath = b ? file.getPath() :context.getCacheDir().getPath();
     ...
     *         created.
     */
    public static RetainFragment findOrCreateRetainFragment(MyApplication fm) {
        // Check to see if we have retained the worker fragment.
        RetainFragment mRetainFragment = (RetainFragment) MyApplication.findFragmentByTag(TAG);

        // If not retained (or first time running), we need to create and add it.
        if (mRetainFragment == null) {
            mRetainFragment = new RetainFragment();
            //TODO set mRetainFragment to MyApplication 
        }
